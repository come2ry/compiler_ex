...
@.str.1 = private unnamed_addr constant [5 x i8] c"%dA\0A\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"not 1\0A\00", align 1
...
8:                                                ; preds = %0
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0))
  br label %10
